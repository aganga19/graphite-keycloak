...
public class Step implements Comparable<Step> {
    ...
    public Step(String providerId) {
        this.providerId = providerId;
    }

    public Step(String providerId, MultivaluedHashMap<String, String> config, List<Step> steps) {
        this.providerId = providerId;
        this.config = config;
        this.steps = steps;
    }

    public Step(ComponentModel model) {
        this.id = model.getId();
    ...
    public Step setConfig(String key, String value) {
        if (config == null) {
