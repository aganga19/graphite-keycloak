...
import org.keycloak.models.workflow.AddRequiredStepProvider;
import org.keycloak.models.workflow.AddRequiredStepProviderFactory;
        ...
        managedRealm.admin().workflows().create(WorkflowRepresentation.create()
                ...
                .withSteps(
                        WorkflowStepRepresentation.create()
                                .of(AddRequiredStepProviderFactory.ID)
                                .withConfig(AddRequiredStepProvider.REQUIRED_ACTION_KEY, "UPDATE_PASSWORD")
                                .build()
                ).build()).close();
