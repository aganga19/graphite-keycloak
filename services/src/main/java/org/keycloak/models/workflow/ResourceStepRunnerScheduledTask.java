 ...
 */
final class ResourceStepRunnerScheduledTask implements ScheduledTask {

    private final Logger logger = Logger.getLogger(ResourceStepRunnerScheduledTask.class);

    private final KeycloakSessionFactory sessionFactory;

    ResourceStepRunnerScheduledTask(KeycloakSessionFactory sessionFactory) {
